    ...
    <>
      <Routes>
        ...
        <Route
          exact
          path="profile"
          element={<SectionsComponent userClient />}
        />
...
export const AuthAdvisorRouter = () => {
  ...
  return (
    <Routes>
      <Route exact path="/*" element={<AuthAdvisorHome />} />
    ...
    <>
      <Routes>
        ...
        <Route
          exact
          path="profile"
          element={<SectionsComponent userAdvisor />}
        />
...
export const AuthAdminRouter = () => {
  ...
  return (
    <Routes>
      <Route exact path="/*" element={<AuthHomeAdmin />} />
