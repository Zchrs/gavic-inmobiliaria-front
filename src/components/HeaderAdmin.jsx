  ...
  return (
    <AdminHeader>
        <div className="headeradmin">
            ...
            <div className="headeradmin-group"><Link className="headeradmin-group-a">Arrendamientos</Link><Link className="headeradmin-group-a">Ventas</Link></div>
            <div className="headeradmin-group"><Link className="headeradmin-group-a btnhead">Clientes</Link><Link className="headeradmin-group-a">Asesores</Link></div>
            <div className="headeradmin-group"><Link className="headeradmin-group-a">Finanzas</Link><Link className="headeradmin-group-a">comunicaciones</Link></div>
        </div>
        <div className="headeradmin-mobile">
            <div id="header-admin" className="headeradmin-mobile-header">
                <div><img className="headeradmin-mobile-header-logo" onClick={handleFunctions} src={getImg("svg", "logo", "svg")} alt="" /></div>
                <div><img className="headeradmin-mobile-header-menu" onClick={handleFunctions} src={getImg("svg", "menu", "svg")} alt="" /></div>
                <div className="headeradmin-mobile-header-avatar">
                    <p>Default name</p>
                    <img className="headeradmin-mobile-header-avatarimg" onClick={handleFunctions} src={getImg("jpg", "default", "jpg")} alt="" />
                </div>
            </div>
